...
public class _FlexUnitApplication_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _FlexUnitApplication_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "FlexUnitApplication" : String(params[0]);
...
,
            ...
            compiledResourceBundleNames: [ "FlexUnitTestRunner", "SharedResources", "collections", "components", "containers", "controls", "core", "effects", "formatters", "layout", "logging", "messaging", "rpc", "skins", "styles" ],
            creationComplete: "onCreationComplete()",
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "FlexUnitApplication",
            minHeight: "600",
            minWidth: "955",
            mixins: [ "_FlexUnitApplication_FlexInit", "_FlexUnitApplication_Styles", "mx.messaging.config.LoaderConfig" ],
            placeholderRsls: [
