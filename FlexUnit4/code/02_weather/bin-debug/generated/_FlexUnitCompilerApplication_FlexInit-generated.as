...
[Mixin]
public class _FlexUnitCompilerApplication_FlexInit
{
   public function _FlexUnitCompilerApplication_FlexInit()
   {
       super();
   }
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         ...
                         ["mx.collections.ArrayCollection","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.collections.ArrayList","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.config.ConfigMap","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.AcknowledgeMessage","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.AcknowledgeMessageExt","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.AsyncMessage","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.AsyncMessageExt","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.CommandMessage","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.CommandMessageExt","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.ErrorMessage","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.HTTPRequestMessage","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.MessagePerformanceInfo","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.utils.ObjectProxy","FlexUnitCompilerApplication","_FlexUnitCompilerApplication_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
